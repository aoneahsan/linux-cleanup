...
proceeding skill-less. (Owner directive 2026-07-11; full text in `~/.claude/AGENTS.md`.)
...
`~/Documents/ahsan-work/ahsan-notebook/static/assets/personal/orcid-project-projects-files/linux-cleanup.bib`, beside a
